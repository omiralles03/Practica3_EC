...
BENCHMARKS["art"]="art -scanfile c756hel.in -trainfile1 a10.img -trainfile2 hc.img -stride 2 -startx 110 -starty 200 -endx 160 -endy 240 -objects 10 > ref.1.out 2> ref.1.err"
BENCHMARKS["gzip"]="gzip input.random 60 > input.random.out 2> input.random.err"
BENCHMARKS["mesa"]="mesa -frames 1000 -meshfile mesa.in -ppmfile mesa.ppm"
BENCHMARKS["twolf"]="twolf ref > ref.stdout 2> ref.err"
...
execute_simulation() {
  ...
  cd "$BASE_DIR/../Benchmarks/$BENCH/data/ref" || return
