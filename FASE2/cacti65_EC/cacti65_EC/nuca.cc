...
// Per alguna rao que desconeixo hi ha un "if" (linea XX) que accedix a la posicio '7' dels banks i per tant cal 8 posicions al vector. Crec que es un error, pero un codi que no s'accedeix mai!!
